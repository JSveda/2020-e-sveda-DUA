...
import com.main.tests.StepCounter;
...
public class InputDataProcessingTestPage implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        File htmlFile = new File("src/main/java/com/main/htmlFiles/inputDataProcessingTestPage.html");
    ...
    public void chooseFile(ActionEvent actionEvent) {
        ...
        if (!inputFile.isFile() || !inputFile.exists()) {
            ...
            Testers.setMethodName("minMaxZeVstupu");
            if (TestRunner.test(InputDataProcessor.class)) {
