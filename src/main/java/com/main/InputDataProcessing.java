...
public class InputDataProcessing implements Initializable {
    @javafx.fxml.FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        File htmlFile = new File("src/main/java/com/main/htmlFiles/inputDataProcessing.html");
    ...
    public void goToTestPage(Event event) {
        try {
            root = FXMLLoader.load(Objects.requireNonNull(Main.class.getResource("inputDataProcessingTestPage.fxml")));
            stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
