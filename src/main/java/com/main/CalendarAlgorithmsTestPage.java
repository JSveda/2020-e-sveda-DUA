...
import com.main.tests.DateTester;
...
public class CalendarAlgorithmsTestPage implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        File htmlFile = new File("src/main/java/com/main/htmlFiles/calendarAlgorithmsTestPage.html");
    ...
    public void chooseFile(ActionEvent actionEvent) {
        ...
        if (!inputFile.isFile() || !inputFile.exists()) {
            ...
            Testers.setMethodName("vcera");
            if (TestRunner.test(DateTester.class)) {
