...
import com.main.tests.InputDataProcessor;
import com.main.tests.MatrixTester;
...
public class MatrixAlgorithmsTestPage implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        File htmlFile = new File("src/main/java/com/main/htmlFiles/matrixAlgorithmsTestPage.html");
    ...
    public void chooseFile(ActionEvent actionEvent) {
        ...
        if (!inputFile.isFile() || !inputFile.exists()) {
            ...
            Testers.setMethodName("soucetPrvkuPodHlavniDiagonalou");
            if (TestRunner.test(MatrixTester.class)) {
