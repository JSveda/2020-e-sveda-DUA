...
public class ArraySearchingTestPage implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        File htmlFile = new File("src/main/java/com/main/htmlFiles/arraySearchingTestPage.html");
    ...
    public void chooseFile(ActionEvent actionEvent) {
        ...
        if (!inputFile.isFile() || !inputFile.exists()) {
            ...
            Testers.setMethodName("pocetKrokuBinarnihoVyhledavani");
            if (TestRunner.test(StepCounter.class)) {
